...
- 2026-09-26: minor UI changes in material dsc and contents; hidden format by default in material dsc as the model should remove it, but we keep it for backwards compatibility.
...
- 2026-09-23:
  ...
  - bumped versions for all libraries.
  ...
  - implemented Vitest tests and fixed various bugs.
- 2026-09-22:
  - 🆕 added `CodLocationRangesPart`.
  - updated packages.
- 2026-09-03: 🆕 added `hideArtists` setting to decorations part.
